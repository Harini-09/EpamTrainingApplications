...
class UserControllerTest {
	...
	void validateAdmin() throws Exception {
		user = new User("sam","sam@112","admin");
		Mockito.when(authentication.logIn(user)).thenReturn(true);
	...
	void validateInvalidAdmin() throws Exception {
		user = new User("sam","sam@112","admin");
		Mockito.when(authentication.logIn(user)).thenReturn(false);
	...
	void validateUser() throws Exception{
		user = new User("sam","sam@112","user");
		Mockito.when(authentication.logIn(user)).thenReturn(true);
		MvcResult mvcResult = mockMvc.perform(
	...
	void registeruser() throws Exception{
		user = new User("sam","sam@112","user");
		Mockito.when(authentication.signUp(user)).thenReturn(true);
		MvcResult mvcResult = mockMvc.perform(
