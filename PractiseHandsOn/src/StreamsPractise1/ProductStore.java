...
public class ProductStore {
	public List<Product> getProducts() {
		...
		Product product100 =new Product("Men's Fashion", "Titan Watch", 4800, 1);
		...
		Product product8 = new Product("Electronics", "Sony Video Projector", 425000, 4);
		...
		return Arrays.asList(product1,product100, product2, product3, product4, product5, product6, product7, product8, product9,
